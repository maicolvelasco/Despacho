...
<?php
include '../../controllers/vendedor/RegistroRecibirController.php';
?>
<body class="bg-light">
...
<div class="container" style="margin-top: 70px; margin-bottom: 60px;">
    ...
    <form action="Registro_Recibir.php" method="POST" id="registrar_recibir_form">
            ...
            <div class="row mb-3">
                <div class="col-6">
                    <div class="input-group">
                        ...
                        <select class="form-select" id="remision_id" name="remision_id" onchange="window.location.href='Registro_Recibir.php?remision_id=' + this.value" required>
...
<footer class="text-white d-flex justify-content-between align-items-center" style="padding: 5px 10px; height: 70px; position: fixed; bottom: 0; width: 100%; z-index: 998;">
    ...
    <a href="Vendedor_Dashboard.php" class="btn" style="color: black; background-color: white; margin-right: 10px; border: 2px solid red;">
