...
<?php require_once '../../controllers/vendedor/ModificarPalletsController.php' ?>
...
<div class="container">
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <form action="../../controllers/vendedor/ModificarPalletsController.php" method="POST">
...
<!-- Botón de Cancelar -->
<a href="Vendedor_Dashboard.php" class="btn btn-outline-danger position-fixed" style="color: black; background-color: white; margin-left: 10px; border: 2px solid red; bottom: 12px; left: 12px; z-index: 9999;">
