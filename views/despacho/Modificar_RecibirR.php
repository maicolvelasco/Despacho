...
<?php require_once '../../controllers/despacho/ModificarRecibirController.php'; ?>
...
<div class="container">
    ...
    <div class="card mb-2">
        <div class="card-body">
            ...
            <form action="../../controllers/despacho/ModificarRecibirController.php" method="POST" id="modificarRecibirForm">
...
<!-- Botón de Cancelar -->
<a href="Despacho_Dashboard.php" class="btn btn-outline-danger position-fixed" style="color: black; background-color: white; margin-right: 10px; border: 2px solid red; bottom: 12px; right: 12px; z-index: 9999;">
