...
<?php
include '../../controllers/despacho/RegistroController.php';
?>
<body class="bg-light">
<nav class="navbar navbar-expand navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand btn" href="Despacho_Dashboard.php">
...
<div class="container" style="margin-top: 70px; margin-bottom: 70px;">
    ...
    <form action="Registro_Envio.php" method="POST" id="registrar_envio_form">
...
<footer class="text-white d-flex justify-content-between align-items-center" style="padding: 5px 10px; height: 70px; position: fixed; bottom: 0; width: 100%; z-index: 998;">
    ...
    <a href="Despacho_Dashboard.php" class="btn" style="color: black; margin-right: 10px; border: 2px solid red;">
...
<script>
    ...
    // Comprimir la imagen con menor calidad
    const dataURL = canvas.toDataURL('image/jpeg', 0.5); // Reducir calidad al 50%
    ...
    document.getElementById('codigo').addEventListener('blur', function() {
        ...
        fetch(`../../controllers/despacho/RegistroController.php?action=buscar_codigo&codigo=${encodeURIComponent(codigo)}`)
