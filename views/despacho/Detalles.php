...
<?php require_once '../../controllers/despacho/DetallesController.php'; ?>
...
<div class="d-flex justify-content-end" style="position: fixed; bottom: 12px; width: 100%; padding: 0 20px; z-index: 1000;">
    ...
    <?php if ($tipo === 'recibir' && $detalle['estado'] === 'en_transito'): ?>
        ...
        <a href="Modificar_RecibirR.php?id=<?php echo htmlspecialchars($id); ?>&tipo=recibir" class="btn btn-outline-secondary" style="color: black; background-color: white; border: 2px solid gray;">
            <i class="bi bi-pen" style="color: gray; font-size: 1.5em;"></i> Observaciones</i> <!-- Ícono de edición dentro del botón flotante -->
        </a>
    <?php endif; ?>
</div>
