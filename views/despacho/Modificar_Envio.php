...
<?php require_once '../../controllers/despacho/ModificarController.php'; ?>
<body class="bg-light">
...
<div class="container" style="margin-top: 70px; margin-bottom: 70px;">
    ...
    <form action="Modificar_Envio.php?id=<?php echo htmlspecialchars($envio_id); ?>" method="POST" id="modificar_envio_form">
...
<footer class="text-white d-flex justify-content-between align-items-center" style="padding: 5px 10px; height: 70px; position: fixed; bottom: 0; width: 100%; z-index: 999">
    ...
    <button type="submit" form="modificar_envio_form" class="btn" style="color: dark; background-color: white; margin-left: 10px; border: 2px solid green;">
        <i class="bi bi-save" style="color: green; font-size: 1.5em;"></i> Guardar
    </button>
    ...
    <a href="Despacho_Dashboard.php" class="btn" style="color: dark; background-color: white; margin-right: 10px; border: 2px solid red;">
        <i class="bi bi-x-circle" style="color: red; font-size: 1.5em;"></i> Cancelar
    </a>
</footer>
