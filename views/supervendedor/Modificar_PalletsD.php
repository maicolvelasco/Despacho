...
<?php require_once '../../controllers/supervendedor/ModificarPalletsDController.php' ?>
...
<div class="container">
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <form action="../../controllers/supervendedor/ModificarPalletsDController.php" method="POST">
...
<a href="#" onclick="document.querySelector('form').submit();" id="guardarBtn" class="btn btn-outline-primary position-fixed" 
   style="color: black; background-color: white; margin-right: 10px; border: 2px solid blue; bottom: 12px; right: 12px; z-index: 9999;">
    <i class="bi bi-floppy" style="color: blue; font-size: 1.5em;"></i> Guardar
</a>

<!-- Botón de Cancelar -->
<a href="Supervendedor_Dashboard.php" class="btn btn-outline-danger position-fixed" style="color: black; background-color: white; margin-left: 10px; border: 2px solid red; bottom: 12px; left: 12px; z-index: 9999;">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Verificar el contenido de la observación
        observacionInput.addEventListener('input', function () {
            if (observacionInput.value.trim().length > 0) {
                guardarBtn.classList.remove('disabled'); // Habilita el botón
            } else {
                guardarBtn.classList.add('disabled'); // Deshabilita el botón si está vacío
            }
        });

        // Evita el envío del formulario si el botón está deshabilitado
        guardarBtn.addEventListener('click', function (event) {
            if (guardarBtn.classList.contains('disabled')) {
                event.preventDefault(); // Cancela el evento de clic
                alert('Por favor, llena el campo de observación antes de guardar.');
            }
        });
    });
</script>
