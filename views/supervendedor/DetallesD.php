    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <!-- Botón de Aceptar Registro -->
                <?php if (($tipo === 'recibir' && $detalle['estado'] === 'en_transito') || 
                          ($tipo === 'envio' && $detalle['estado'] === 'en_transito')): ?>
                    <button type="button" class="btn btn-outline-success" onclick="aceptarEnTransito(<?php echo $id; ?>, '<?php echo $tipo; ?>')">
...
<div class="d-flex justify-content-end" style="position: fixed; bottom: 12px; width: 100%; padding: 0 20px; z-index: 1000;">
    <!-- Botón de Modificar -->
    <?php if (($tipo === 'envio' && $detalle['estado'] === 'en_transito') || ($tipo === 'recibir' && $detalle['estado'] === 'en_transito')): ?>
        <a href="Modificar_PalletsD.php?id=<?php echo htmlspecialchars($id); ?>&tipo=<?php echo htmlspecialchars($tipo); ?>" 
