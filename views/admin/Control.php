...
<body class="bg-light" style="font-size: 0.75em;">
    ...
    <?php require_once '../../controllers/admin/ControlController.php'; ?>

    <!-- Barra de navegación siempre expandida -->
    <nav class="navbar navbar-expand navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <!-- Eliminado el botón de toggler ya que la navbar nunca se colapsa -->
            <!-- Contenedor siempre visible sin clases de colapso -->
            <div class="d-flex align-items-center w-100">
                ...
                <ul class="navbar-nav mb-0">
                    <li class="nav-item me-3">
                        <a href="Notificaciones.php" class="btn btn-primary rounded-circle position-relative" style="width: 35px; height: 35px; margin-right: 30px; margin-top: 6px; display: flex; align-items: center; justify-content: center;" title="Notificaciones">
    ...
    <div class="container" style="margin-top: 130px;">
        ...
        <!-- Sección de Envíos -->
        <section id="envios" class="mb-4 items-scrollable">
            <?php if (isset($envios) && count($envios) > 0): ?>
                <?php foreach ($envios as $envio): ?>
                    ...
                    ?>
                    <a href="DetallesA.php?id=<?php echo htmlspecialchars($envio['envio_id']); ?>&tipo=envio" class="text-decoration-none text-dark envio-item" 
        ...
        <!-- Sección En Tránsito -->
        <section id="enTransito" class="mb-4 d-none items-scrollable">
                ...
                <?php foreach ($recibirEnTransito as $rec): ?>
                    <div class="recibir-item enTransito-item" 
                        ...
                        <div class="d-flex align-items-center border rounded p-3 mb-2 bg-white shadow-sm justify-content-between">
                            <a href="DetallesA.php?id=<?php echo htmlspecialchars($rec['recibir_id']); ?>&tipo=recibir" class="text-decoration-none text-dark flex-grow-1">
                                <div class="d-flex align-items-center">
    ...
    <button type="button" style="bottom: 12px;" class="btn btn-danger rounded-circle floating-btn d-flex align-items-center justify-content-center" data-toggle="modal" data-target="#modalFechas">
    ...
    <script>
            ...
            $('#btnDescargar').click(function() {
                ...
                if (fechaInicio && fechaFin) {
                    // Redirigir a la URL de descarga con las fechas como parámetros
                    window.location.href = `generate_pdf.php?fecha_inicio=${fechaInicio}&fecha_fin=${fechaFin}`;
                } else {
        ...
        function mostrarSeccion(seccion) {
            ...
            const botonActivo = document.querySelector(`.btn-filter[onclick="mostrarSeccion('${seccion}')"]`);
            if (botonActivo) {
        ...
        function handleClick(id) {
            ...
            fetch('../../controllers/admin/ControlController.php', {
                method: 'POST',
        ...
        // Función para aceptar una recepción en tránsito.
